...
const FoodChatbot = () => {
  ...
  setMessages([
    {
      text: "Hi! Welcome 🍽️ .How can I help you today?",
      sender: "bot",
    },
  ]);
};
  ...
  const rules = [
    ...
    { keywords: ["order now button"], response: "The order now button is at the bottom of the list, before the footer" },
    ...
    // APPETIZERS (15)
    { keywords: ["appetizer"], response: "Our appetizers include fries,Cheesy nachos, wings, Crispy onion rings, Mozzarella sticks, samosas and spring rolls." },
    { keywords: ["fries"], response: "We serve crispy french fries 🍟." },
    { keywords: ["wings"], response: "Our chicken wings are very popular 🍗." },
    { keywords: ["samosa"], response: "We have beef samosas." },
    ...
    { keywords: ["juic-e"], response: "We have mango, passion and orange juice 🧃." },
